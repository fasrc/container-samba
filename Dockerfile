...
RUN apk add --no-cache bash samba samba-winbind samba-winbind-clients samba-libnss-winbind krb5 samba-winbind-krb5-locator linux-pam nss-pam-ldapd && rm -rf /var/cache/apk/*
