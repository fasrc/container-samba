...
RUN apk add --no-cache bash samba samba-winbind samba-winbind-clients samba-libnss-winbind samba-winbind-krb5-locator krb5 tdb linux-pam nss-pam-ldapd && rm -rf /var/cache/apk/*
